...
//    Serial.println(incomingByte, DEC);
    ...
    Serial.print("EE pwm value: "); Serial.println(EEcurrentValue); Serial.println();
    ...
    switch (incomingByte) {
      ...
      /// Servo #3
      case 'e':  // adjust pwm value out of 4096 until servo just fails to actuate, then bring it back a step
        J2currentValue += 4;
        break;
      case 'd':
        J2currentValue -= 4;
      ...
      /// Reset
      case 'g':  // reset pwm values to those representing the starting configuration 
